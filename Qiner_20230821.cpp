...
struct Miner
{
    ...
    #define SOLUTION_THRESHOLD 1120	//change every week
    ...
    void initialize()
    {
        ...
        randomSeed[0] = 0;		//change every week
        randomSeed[1] = 0;		//change every week
        randomSeed[2] = 0;      //change every week
        randomSeed[3] = 0;      //change every week
        randomSeed[4] = 0;      //change every week
        randomSeed[5] = 0;      //change every week
        randomSeed[6] = 0;      //change every week
        randomSeed[7] = 0;      //change every week
        random(randomSeed, randomSeed, (unsigned char*)data, sizeof(data));//data change every week, remain constant during the week
...
int main(int argc, char* argv[])
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                CreateThread(NULL, 25165824, miningThreadProc, 0, 0, NULL);
            }
